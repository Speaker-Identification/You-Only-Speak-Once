...
to run you need Aws_Access_Key_Id and Aws_Secret_Access_Key of s3 bucket.
create an .env file inside demo folder and set values of this two variable before running docker file
```shell script
$ docker build -t yoso .
